...
namespace Visyde
{
    ...
    public class ItemSpawner : UnityEngine.MonoBehaviour
    {
        ...
        [Header("OtherSpawning")]
        public string btnPrefab;
        public string keyPrefab;
        public string gatePrefab;

        public List<GameMap> mapPrefabs;
        ...
        void Update()
        {
            if (Connector.instance.networkRunner.IsServer && gm.gameStarted && !gm.isGameOver)
            {
                // Spawn weapons:
        ...
        void SpawnWeapon(int index)
        {
            ...
            int spawnId = UnityEngine.Random.Range(0, map.spawnableWeapons.Length);
