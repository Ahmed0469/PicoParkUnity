...
namespace Visyde
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        [Header("Settings:")]
        public string gameStartMessage = "Go Pookies!";				// text to show when the match begins
        ...
        public Button menuPanelRestartBtn;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Escape) && !gm.useMobileControls)
            {
                ...
                {
                    menuPanelRestartBtn.interactable = Connector.instance.networkRunner.IsServer;
                }
                else
                {
                    menuPanelRestartBtn.interactable = true;
                }
            }
            ...
            if (gm.isGameOver)
            {
                ...
                //        winningPlayerText.text = GameManager.isDraw ? "Game Over!" : gm.playerRankings[0];
            ...
            if (!gm.isGameOver)
            {
                ...
                for (int i = 0; i < leaderboardItems.Length; i++)
                {
                    if (playersSorted.Length > i)
                    {
                        ...
                        leaderboardItems[i].playerName.color = leaderboardItems[i].playerName.text == PlayerPrefs.GetString("USERNAME") ? Color.cyan : Color.white;
